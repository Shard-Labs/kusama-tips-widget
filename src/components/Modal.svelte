...
<div
  ...
  <div
    role="dialog"
    aria-modal="true"
    class="h-full w-full md:h-auto md:max-w-xl rounded shadow-md bg-background">
    <div class="px-8 py-6 flex justify-between items-center bg-white">
      ...
      <button on:click={close}>
        <svg
          class="w-8 h-8 h-wull fill-current text-gray-800"
