...
<Modal index={1} on:close  {selected}>
  <h2 slot="header" class="text-xl text-gray-900 leading 8">Select Polkadot Account</h2>
  <ul slot="content">
    {#each $accounts as account}
      <li class="text-sm text-gray-700 rounded shadow p-4 m-8 bg-white truncate"
        on:click={() => {
